...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (!post) return {};
  return {
    title: `${post.title} | ぷらっとハウス渋谷Ⅱ（東）`,
    description: post.excerpt,
    alternates: {
      canonical: `https://shibuya2.plat-house.jp/blog/${slug}`,
    },
  };
}
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-16">
      ...
      <div className="mt-16 bg-gray-900 text-white rounded-2xl p-8 text-center">
        <p className="font-bold text-lg mb-2">ぷらっとハウス渋谷Ⅱ（東）</p>
        <p className="text-gray-400 text-sm mb-6">渋谷駅10分・ファミリールーム・最大2名</p>
        <a
          href="https://beds24.com/booking.php?propid=293360&referer=BookingLink"
